...
public class ManJianZheKouExecutor extends AbstractExecutor
    ...
    protected boolean isGoodsTypeSatisfy(SettlementInfo settlement) {
        ...
        settlement.getCouponTemplateInfos().forEach(ct -> {
    ...
    public SettlementInfo computeRule(SettlementInfo settlement) {
        ...
        SettlementInfo.CouponTemplateInfo manJian = null;
        SettlementInfo.CouponTemplateInfo zheKou = null;

        for (SettlementInfo.CouponTemplateInfo ct :
                settlement.getCouponTemplateInfos()) {
        ...
        if (!isTemplateCanShared(manJian, zheKou)) {
            ...
            settlement.setCouponTemplateInfos(Collections.emptyList());
            return settlement;
        }

        List<SettlementInfo.CouponTemplateInfo> ctInfos = new ArrayList<>();
        ...
        settlement.setCouponTemplateInfos(ctInfos);
    ...
    @SuppressWarnings("all")
    private boolean
    isTemplateCanShared(SettlementInfo.CouponTemplateInfo manJian,
                        SettlementInfo.CouponTemplateInfo zheKou) {
